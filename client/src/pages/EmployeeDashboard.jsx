        ...
        <Layout>
             <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8 flex items-center justify-between">
                ...
                <div className="text-right">
                    <p className="text-3xl font-mono font-bold text-gray-900 dark:text-white">09:41 AM</p>
                    <p className="text-sm text-gray-400">Wednesday, Nov 23</p>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow cursor-pointer">
